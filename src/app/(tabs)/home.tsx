...
export default function Page() {
  ...
  useEffect(() => {
    const checkExistingProfile = async () => {
      ...
      try {
        const BACKEND_URL = Platform.OS === 'android' ? 'http://10.0.2.2:5000' : 'http://192.168.100.137:5000';
...
const handleContinue = async () => {
  ...
  if (!age || !heightCm || !weightKg) {
    alert("Please fill in your Age, Height, and Weight before moving forward!");
    return;
  }
